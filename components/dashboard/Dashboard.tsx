          ...
          {modoFiltro === "mes" ? (
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="px-3 py-1.5 bg-white border border-border rounded-lg text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring appearance-none cursor-pointer pr-7"
